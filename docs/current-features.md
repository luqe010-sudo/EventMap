...
- mapa pobiera osobny lekki zestaw pinezek dla wszystkich wydarzen pasujacych do aktualnych filtrow, niezaleznie od paginowanej listy kart; dane pinezki zawieraja tylko identyfikator, wspolrzedne i minimum informacji do koloru/ikony.
