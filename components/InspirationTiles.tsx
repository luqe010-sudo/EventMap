...
const tiles = [
  ...
  { emoji: "👨‍👩‍👧", label: "Dla rodzin", category: "Rodzinne" as EventCategory, gradient: "linear-gradient(135deg, #c7d2fe, #a5b4fc)" },
  { emoji: "🎵", label: "Muzyka", category: "Koncerty" as EventCategory, gradient: "linear-gradient(135deg, #ddd6fe, #c4b5fd)" },
  ...
  { emoji: "🎪", label: "Festyny", category: "Festyny" as EventCategory, gradient: "linear-gradient(135deg, #fef3c7, #fbbf24)" },
